...
import com.bill.services.ProductServiceImp;
import com.bill.services.UserRegisterService;
import com.bill.services.UserRegisterServiceImp;
       ...
       do {
           ...
           switch (choice) {
               ...
               case 2:
                   AdminPanel();
                   break;
               case 3: System.out.println("Existing system");
                   System.exit(0);
                   break;
               default:
    ...
    public static void customerPanel() {
        ...
        do{
            ...
            switch(choice) {
                ...
                case 2:
                   sc.nextLine();
                    System.out.println("Enter the your valid email  ");
                    String useremail = sc.nextLine();
                    System.out.println("Enter your valid password ");
                    String userpassword = sc.nextLine();
                    try {
                        boolean login = custregisterservice.ValidateCustomer(useremail, userpassword);
                        if (login) {
